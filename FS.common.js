...
var isWeb = require("react-native").Platform.OS === "web";

var RNFSFileTypeRegular = !isWeb ? RNFSManager.RNFSFileTypeRegular : null;
var RNFSFileTypeDirectory = !isWeb ? RNFSManager.RNFSFileTypeDirectory : null;
...
var RNFS = {
  ...
  MainBundlePath: !isWeb ? RNFSManager.RNFSMainBundlePath : null,
  CachesDirectoryPath: !isWeb ? RNFSManager.RNFSCachesDirectoryPath : null,
  ExternalCachesDirectoryPath: !isWeb
    ? RNFSManager.RNFSExternalCachesDirectoryPath
    : null,
  DocumentDirectoryPath: !isWeb ? RNFSManager.RNFSDocumentDirectoryPath : null,
  DownloadDirectoryPath: !isWeb ? RNFSManager.RNFSDownloadDirectoryPath : null,
  ExternalDirectoryPath: !isWeb ? RNFSManager.RNFSExternalDirectoryPath : null,
  ExternalStorageDirectoryPath: !isWeb
    ? RNFSManager.RNFSExternalStorageDirectoryPath
    : null,
  TemporaryDirectoryPath: !isWeb
    ? RNFSManager.RNFSTemporaryDirectoryPath
    : null,
  LibraryDirectoryPath: !isWeb ? RNFSManager.RNFSLibraryDirectoryPath : null,
  PicturesDirectoryPath: !isWeb ? RNFSManager.RNFSPicturesDirectoryPath : null,
  FileProtectionKeys: !isWeb ? RNFSManager.RNFSFileProtectionKeys : null,
};
